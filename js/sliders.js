...
;// CONCATENATED MODULE: ./source/js/sliders.js
...
function slider(el, config) {
  ...
  const settings = {
    modules: [Navigation, Pagination, Thumb, freeMode],
    loop: false,
    slidesPerView: 'auto',
    spaceBetween: 0,
    preloadImages: false,
...
const swiper = new core('.swiper--thumb', {
  slidesPerView: 'auto',
  watchSlidesProgress: true,
  freeMode: true
});
const sliderFood = document.querySelectorAll('[data-slider="food-slider"]');
sliderFood.forEach(item => slider(item, {
  loop: false,
  thumbs: {
    swiper
  },
...
const sliderCompanies = document.querySelectorAll('[data-slider="companies-slider"]');
sliderCompanies.forEach(item => slider(item, {
  loop: false,
  navigation: {
...
const sliderBaseOne = document.querySelectorAll('[data-slider="swiper-base-one"]');
sliderBaseOne.forEach(item => slider(item, {
  loop: true,
  slidesPerView: 'auto'
}));
const sliderMovement = document.querySelectorAll('[data-slider="swiper-movement"]');
sliderMovement.forEach(item => slider(item, {
  loop: true,
  slidesPerView: 'auto'
}));
const sliderHousing = document.querySelectorAll('[data-slider="swiper-housing"]');
sliderHousing.forEach(item => slider(item, {
  loop: true,
  slidesPerView: 'auto'
}));
const sliderBlog = document.querySelectorAll('[data-slider="swiper-blog"]');
...
const swiperBase = document.querySelector('.swiper--base');
if (swiperBase) {
  const workSlider = new core(swiperBase, {
    slidesPerView: 'auto',
    loop: false,
  ...
  workSlider.on('slideChange', () => {
    ...
    document.querySelector(`.accordion-mini[data-index="${workSlider.realIndex}"]`).classList.add('active');
  });
  const focusItem = document.querySelectorAll('.accordion-mini');
